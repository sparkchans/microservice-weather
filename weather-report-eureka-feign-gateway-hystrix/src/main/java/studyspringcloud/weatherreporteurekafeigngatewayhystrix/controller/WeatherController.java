package studyspringcloud.weatherreporteurekafeigngatewayhystrix.controller;
...
import studyspringcloud.weatherreporteurekafeigngatewayhystrix.service.DataClient;
...
public class WeatherController {
    ...
    public ModelAndView getReportByCityId(@PathVariable("cityId") String cityId, Model model) {
        ...
        model.addAttribute("report", dataClient.getDataByCityId(cityId));
